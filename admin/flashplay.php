...
if ($_REQUEST['act']== 'list')
{
    ...
    $smarty->display($_CFG['template_name'].'flashplay_list.htm');
}
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    if (empty($_POST['step']))
    {
        ...
        $smarty->display($_CFG['template_name'].'flashplay_add.htm');
    }
    elseif ($_POST['step'] == 2)
    {
...
//        }
    ...
    $smarty->display($_CFG['template_name'].'flashplay_custom.htm');
}
...
//        }
    ...
    $smarty->display($_CFG['template_name'].'flashplay_custom_add.htm');
}
...
elseif ($_REQUEST['act'] == 'custom_edit')
{
    ...
    /* 添加 */
    $smarty->assign('ad', $ad);
    $smarty->display($_CFG['template_name'].'flashplay_ccustom_edit.htm');
