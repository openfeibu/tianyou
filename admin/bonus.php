...
if ($_REQUEST['act'] == 'list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'bonus_type.htm');
}
...
if ($_REQUEST['act'] == 'add')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'bonus_type_info.htm');
}
...
if ($_REQUEST['act'] == 'send')
{
    ...
    if ($_REQUEST['send_by'] == SEND_BY_USER)
    {
        ...
        $smarty->display($_CFG['template_name'].'bonus_by_user.htm');
    }
    elseif ($_REQUEST['send_by'] == SEND_BY_GOODS)
    {
        ...
        $smarty->display($_CFG['template_name'].'bonus_by_goods.htm');
    }
    elseif ($_REQUEST['send_by'] == SEND_BY_PRINT)
    {
        $smarty->assign('type_list',    get_bonus_type());

        $smarty->display($_CFG['template_name'].'bonus_by_print.htm');
    }
}
...
if ($_REQUEST['act'] == 'bonus_list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'bonus_list.htm');
}
