...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->display($_CFG['template_name'].'templates_list.htm');
}
...
if ($_REQUEST['act'] == 'setup')
{
    ...
    $smarty->display($_CFG['template_name'].'template_setup.htm');
}
...
if ($_REQUEST['act'] == 'library')
{
    ...
    $smarty->display($_CFG['template_name'].'template_library.htm');
}
...
if ($_REQUEST['act'] == 'backup_setting')
{
    ...
    $smarty->display($_CFG['template_name'].'templates_backup.htm');
}
