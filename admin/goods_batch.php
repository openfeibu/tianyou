...
if ($_REQUEST['act'] == 'add')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'goods_batch_add.htm');
}
...
elseif ($_REQUEST['act'] == 'upload')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'goods_batch_confirm.htm');
}
...
elseif ($_REQUEST['act'] == 'select')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'goods_batch_select.htm');
}
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'goods_batch_edit.htm');
}
