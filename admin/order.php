...
if ($_REQUEST['act'] == 'order_query')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'order_query.htm');
}
...
elseif ($_REQUEST['act'] == 'back_detail')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'back_detail.htm');
}
/*------------------------------------------------------ */
//-- 通过审核
/*------------------------------------------------------ */
elseif ($_REQUEST['act'] == 'pase_back')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'back_pase.htm');
}
/*------------------------------------------------------ */
//-- 通过审核提交
/*------------------------------------------------------ */
...
elseif ($_REQUEST['act'] == 'back_tuikuan')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'back_tuikuan.htm');
}
/*------------------------------------------------------ */
//-- 确认退款提交
/*------------------------------------------------------ */
...
elseif ($_REQUEST['act'] == 'stop_back')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'back_stop.htm');
}
/*------------------------------------------------------ */
//-- 取消申请提交
/*------------------------------------------------------ */
...
elseif ($_REQUEST['act'] == 'info')
{
    ...
    if (isset($_GET['print']))
    {
        ...
        $smarty->display($_CFG['template_name'].'order_print.html');
    }
    /* 打印快递单 */
    elseif (isset($_GET['shipping_print']))
    {
        ...
        if ($shipping['print_model'] == 2)
        {
            ...
            $smarty->display($_CFG['template_name'].'print.htm');
        }
    ...
    else
    {
        ...
        /* 显示模板 */
        assign_query_info();
        $smarty->display($_CFG['template_name'].'order_info.htm');
    }
}
...
elseif ($_REQUEST['act'] == 'delivery_list')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'delivery_list.htm');
}
...
elseif ($_REQUEST['act'] == 'delivery_info')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'delivery_info.htm');
    exit; //
}
...
elseif ($_REQUEST['act'] == 'back_list')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'back_list.htm');
}
...
elseif ($_REQUEST['act'] == 'back_info')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'back_info.htm');
    exit; //
}
...
//        }
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'order_step.htm');
}
...
elseif ($_REQUEST['act'] == 'process')
{
    ...
    elseif ('load_refund' == $func)
    {
        ...
        assign_query_info();
        $smarty->display($_CFG['template_name'].'order_refund.htm');
    }
...
elseif ($_REQUEST['act'] == 'merge')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'merge_order.htm');
}
...
elseif ($_REQUEST['act'] == 'templates')
{
    ...
    /* 显示模板 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'order_templates.htm');
}
/*------------------------------------------------------ */
//-- 订单打印模板（提交修改）
/*------------------------------------------------------ */
...
elseif ($_REQUEST['act'] == 'operate')
{
    ...
    elseif (isset($_POST['ship']))
    {
        ...
        assign_query_info();
        $smarty->display($_CFG['template_name'].'order_delivery_info.htm');
        exit;
    }
    /* 未发货 */
    ...
    if (($require_note && $action_note == '') || isset($show_invoice_no) || isset($show_refund))
    {
        ...
        assign_query_info();
        $smarty->display($_CFG['template_name'].'order_operate.htm');
    }
    else
    {
        /* 直接处理 */
...
//    $action_note = $_REQUEST['action_note'];
    ...
    else
    {
        ...
        /* 显示模板 */
        assign_query_info();
        $smarty->display($_CFG['template_name'].'order_operate_info.htm');
    }
}
...
function order_list()
{
    ...
    foreach ($row AS $key => $value)
    {
        ...
        $row[$key]['order_time_desc'] = date('Y-m-d H:i:s', $value['add_time']);
