...
if ($_REQUEST['act'] == 'list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'users_list.htm');
}
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'user_info.htm');
}
...
elseif ($_REQUEST['act'] == 'address_list')
{
    ...
    $smarty->assign('action_link',      array('text' => $_LANG['03_users_list'], 'href'=>'users.php?act=list&' . list_link_postfix()));
    $smarty->display($_CFG['template_name'].'user_address_list.htm');
}
...
elseif ($_REQUEST['act'] == 'aff_list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'affiliate_list.htm');
}
