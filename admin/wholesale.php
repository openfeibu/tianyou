...
if ($_REQUEST['act'] == 'list')
{
    ...
    /* 显示商品列表页面 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'wholesale_list.htm');
}
...
elseif ($_REQUEST['act'] == 'batch_add')
{
    ...
    $smarty->display($_CFG['template_name'].'wholesale_batch_info.htm');
}
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('action_link', array('href' => $href, 'text' => $_LANG['wholesale_list']));
    assign_query_info();
    $smarty->display($_CFG['template_name'].'wholesale_info.htm');
}
