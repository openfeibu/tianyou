...
if ($_REQUEST['act'] == 'backup')
{
    ...
    $smarty->display($_CFG['template_name'].'db_backup.htm');
}
...
if ($_REQUEST['act'] == 'restore')
{
    ...
    $smarty->display($_CFG['template_name'].'db_restore.htm');
}
...
if ($_REQUEST['act'] == 'dumpsql')
{
    ...
    if (empty($tables))
    {
        ...
        if ($vol > 1)
        {
            ...
            $smarty->display($_CFG['template_name'].'sql_dump_msg.htm');
        }
        else
        {
            /* 只有一个文件 */
...
if ($_REQUEST['act'] == 'optimize')
{
    ...
    $smarty->display($_CFG['template_name'].'optimize.htm');
}
...
if($_REQUEST['act']=='clear'){
    ...
    $smarty->display($_CFG['template_name'].'clear.htm');
}
/**
* 删除体验数据
*/
