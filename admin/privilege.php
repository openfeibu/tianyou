...
if ($_REQUEST['act'] == 'login')
{
    ...
    $smarty->display($_CFG['template_name'].'login.htm');
}
...
elseif ($_REQUEST['act'] == 'list')
{
    ...
    /* 显示页面 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'privilege_list.htm');
}
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    /* 显示页面 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'privilege_info.htm');
}
...
elseif ($_REQUEST['act'] == 'allot')
{
    ...
    /* 显示页面 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'privilege_allot.htm');
}
