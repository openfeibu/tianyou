...
if ($_REQUEST['act'] == 'list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'integrates_list.htm');
}
...
//        }
        ...
        $smarty->display($_CFG['template_name'].'integrates_setup.htm');
    }
}
...
if ($_REQUEST['act'] == 'check_config')
{
    ...
    $smarty->display($_CFG['template_name'].'integrates_check.htm');
}
...
if ($_REQUEST['act'] == 'save_uc_config_first')
{
    ...
    $smarty->display($_CFG['template_name'].'integrates_uc_import.htm');
}
...
if ($_REQUEST['act'] == 'modify')
{
    ...
    $smarty->display($_CFG['template_name'].'integrates_modify.htm');
}
...
if ($_REQUEST['act'] == 'sync')
{
    ...
    $smarty->assign('size', $size);
    $smarty->display($_CFG['template_name'].'integrates_sync.htm');
}
...
if ($_REQUEST['act'] == 'points_set')
{
    ...
    $smarty->display($_CFG['template_name'].'integrates_points.htm');
}
