...
if ($_REQUEST['act'] == 'list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'user_account_list.htm');
}
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'user_account_info.htm');
}
...
elseif ($_REQUEST['act'] == 'check')
{
    ...
    /* 页面显示 */
    assign_query_info();
    $smarty->display($_CFG['template_name'].'user_account_check.htm');
}
