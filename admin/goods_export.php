...
if ($_REQUEST['act'] == 'goods_export')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'goods_export.htm');
}
...
{
    $smarty->display($_CFG['template_name'].'import_taobao.htm');
}
...
{
    $smarty->display($_CFG['template_name'].'import_paipai.htm');
}
/* 处理Ajax调用 */
