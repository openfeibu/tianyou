...
if ($_REQUEST['act'] == 'list_cat')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'shophelp_cat_list.htm');
}
...
if ($_REQUEST['act'] == 'list_article')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'shophelp_article_list.htm');
}
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->display($_CFG['template_name'].'shophelp_info.htm');
}
