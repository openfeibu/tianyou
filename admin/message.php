...
if ($_REQUEST['act'] == 'list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'message_list.htm');
}
...
elseif ($_REQUEST['act'] == 'send')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'message_info.htm');
}
...
elseif ($_REQUEST['act'] == 'view')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'message_view.htm');
}
