...
if ($_REQUEST['act'] == '')
{
    ...
    $smarty->display($_CFG['template_name'].'index.htm');
}
...
elseif ($_REQUEST['act'] == 'top')
{
    ...
    $smarty->display($_CFG['template_name'].'top.htm');
}
...
{
    $smarty->display($_CFG['template_name'].'calculator.htm');
}
...
// 权限对照表
    ...
    $smarty->assign('admin_id', $_SESSION['admin_id']);
    $smarty->display($_CFG['template_name'].'menu.htm');
}
...
//    $today_start = mktime(0,0,0,date('m'),date('d'),date('Y'));
    ...
    $smarty->display($_CFG['template_name'].'start.htm');
}
...
//    $modules = read_modules('../includes/modules/shipping');
    ...
    $smarty->display($_CFG['template_name'].'setting_first.htm');
}
...
//            $modules = read_modules('../includes/modules/payment');
    ...
    $smarty->display($_CFG['template_name'].'setting_second.htm');
}
...
elseif ($_REQUEST['act'] == 'third')
{
    ...
    $smarty->display($_CFG['template_name'].'setting_third.htm');
}
...
{
    assign_query_info();
    $smarty->display($_CFG['template_name'].'about_us.htm');
}
...
{
    $smarty->display($_CFG['template_name'].'drag.htm');;
}
