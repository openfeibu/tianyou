...
if ($_REQUEST['act'] == 'list')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'shipping_list.htm');
}
...
elseif ($_REQUEST['act'] == 'print_index')
{
    ...
    $smarty->display($_CFG['template_name'].'print_index.htm');
}
...
elseif ($_REQUEST['act'] == 'edit_print_template')
{
    ...
    $smarty->display($_CFG['template_name'].'shipping_template.htm');
}
