...
//        break;
    ...
    case 'display_send_ui' :
        ...
        if ($sms->has_registered())
        {
            ...
            $smarty->display($_CFG['template_name'].'sms_send_ui.htm');
        }
        else
        {
            ...
            assign_query_info();
            $smarty->display($_CFG['template_name'].'sms_register_ui.htm');
        }
      ...
      case 'sms_sign':
        ...
        if ($sms->has_registered())
        {
            ...
            $smarty->display($_CFG['template_name'].'sms_sign.htm');
        }
        else
        {
            $smarty->assign('ur_here', $_LANG['register_sms']);
...
//            assign_query_info();
//            $smarty->display($_CFG['template_name'].'sms_send_history_query_ui.htm');
//        }
//        else
//        {
//            $smarty->assign('ur_here', $_LANG['register_sms']);
...
//                assign_query_info();
//
//                $smarty->display($_CFG['template_name'].'sms_send_history.htm');
//            }
//            else
//            {
...
//            $smarty->display($_CFG['template_name'].'sms_charge_ui.htm');
//        }
//        else
//        {
//            $smarty->assign('ur_here', $_LANG['register_sms']);
...
//            assign_query_info();
//            $smarty->display($_CFG['template_name'].'sms_charge_history_query_ui.htm');
//        }
//        else
//        {
//            $smarty->assign('ur_here', $_LANG['register_sms']);
...
//                assign_query_info();
//
//                $smarty->display($_CFG['template_name'].'sms_charge_history.htm');
//            }
//            else
//            {
...
//            assign_query_info();
//            $smarty->display($_CFG['template_name'].'sms_my_info.htm');
//        }
}
