...
if ($_REQUEST['act'] == 'replenish')
{
    ...
    $smarty->display($_CFG['template_name'].'replenish_info.htm');
}
...
elseif ($_REQUEST['act'] == 'card')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'replenish_list.htm');
}
...
elseif ($_REQUEST['act'] == 'batch_card_add')
{
    ...
    $smarty->assign('goods_id',           $_REQUEST['goods_id']);
    $smarty->display($_CFG['template_name'].'batch_card_info.htm');
}
...
elseif ($_REQUEST['act'] == 'batch_confirm')
{
    ...
    $smarty->display($_CFG['template_name'].'batch_card_confirm.htm');
...
elseif ($_REQUEST['act'] == 'change')
{
    ...
    assign_query_info();
    $smarty->display($_CFG['template_name'].'virtual_card_change.htm');
}
