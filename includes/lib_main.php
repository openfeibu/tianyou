...
function get_app_pager($app, $cat, $record_count, $size, $sort, $order, $page = 1,
                        $keywords = '', $brand = 0, $price_min = 0, $price_max = 0, $display_type = 'list', $filter_attr='', $url_format='', $sch_array='')
{
    $sch = array('keywords'  => $keywords,
                 'sort'      => $sort,
    ...
    else
    {
        ...
        else
        {
            ...
            $pager['page_prev']  = ($page > 1) ? build_uri($app, $uri_args, '', $page_prev, $keywords) : '';
            $pager['page_next']  = ($page < $page_count) ? html_entity_decode(build_uri($app, $uri_args, '', $page_next, $keywords)) : '';
...
function article_categories_tree($cat_id = 0)
{
    ...
    */
    ...
    {
        /* 获取当前分类及其子分类 */
        $sql = 'SELECT a.cat_id, a.cat_name, a.en_cat_name,a.sort_order AS parent_order, a.cat_id, ' .
    ...
    foreach ($res AS $row)
    {
        ...
        $cat_arr[$row['cat_id']]['en_name'] = $row['en_cat_name'];
