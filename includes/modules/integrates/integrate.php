...
class integrate
{
     ...
     * @return int
     */
    function add_user($username, $password, $mobile, $gender = -1, $bday = 0, $reg_date=0, $md5password='')
    {
        /* 将用户添加到整合方 */
        ...
        $fields = array($this->field_name, $this->field_mobile, $this->field_pass);
        $values = array($post_username, $mobile, $post_password);
    ...
    function edit_user($cfg)
    {
        ...
        {
            $values[] = "country ='" . $cfg['country'] . "'";
        }
        if ((!empty($cfg['province'])))
        {
            $values[] = "province ='" . $cfg['province'] . "'";
        }
        if ((!empty($cfg['city'])))
        {
            $values[] = "city ='" . $cfg['city'] . "'";
        }
        if ((!empty($cfg['district'])))
        {
            $values[] = "district ='" . $cfg['district'] . "'";
        }
        if ($values)
        {
