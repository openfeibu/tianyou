...
class wxnative
{
    ...
    function get_code($order, $payment)
    {
        ...
        if(!$code_url){
            $button = '<div style="text-align:center" id="qrcode"><p>生成支付按钮出错(error_code:001)</p><div>';
        ...
        if(JS_QR){
            ...
            if(!is_dir($qr_root_path)){
                if(!mkdir($qr_root_path, 0777, true)){
                    ...
                    $button = '<div style="text-align:center" id="qrcode"><p>生成支付按钮出错(error_code:002)</p><div>';
                    return $javascript.$button;
                }
            }
